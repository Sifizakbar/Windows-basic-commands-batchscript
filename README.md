...
COMMAND AND OUTPUT
![alt text](<Exercise1/Screenshot (577).png>)
Remove the directory "my-folder"

COMMAND AND OUTPUT
![alt text](<Exercise1/Screenshot (578).png>)
...
COMMAND AND OUTPUT
![alt text](<Exercise1/Screenshot (579).png>)
Copy the file hello.txt into the file hello1.txt

COMMAND AND OUTPUT
![alt text](<Exercise1/Screenshot (580).png>)
Remove the file hello1.txt

COMMAND AND OUTPUT
![alt text](<Exercise1/Screenshot (581).png>)
List out the file hello1.txt in the current directory

COMMAND AND OUTPUT
![alt text](<Exercise1/Screenshot (582).png>)
...
COMMAND AND OUTPUT
![alt text](<Exercise1/Screenshot (583).png>)
Exercise 2: Advanced Batch Scripting
Create a batch file named on the desktop. The batch file need to have a variable assigned with a desired name for ex. name="John" and display as "Hello, John".

OUTPUT
![alt text](<Exercise1/Screenshot (584).png>)
...
OUTPUT
![alt text](<Exercise1/Screenshot (585).png>)
Write a batch file that uses a FOR loop to iterate over a sequence of numbers (1 to 5) and displays each number with the label Number:. The output should pause at the end.

OUTPUT
![alt text](<Exercise1/Screenshot (586).png>)
